...
// used to assign ids to Contacts - simulates the auto increment // primary key for Contacts in a database
...
// properly filters for the given term.
        ...
        lastNameMatches = (lastNameCriteria == null || lastNameCriteria.isEmpty()) ? truePredicate
                : (c) -> c.getLastName().equals(lastNameCriteria);
        companyMatches = (companyCriteria == null || companyCriteria.isEmpty()) ? truePredicate
        ...
        emailMatches = (emailCriteria == null || emailCriteria.isEmpty()) ? truePredicate
                : (c) -> c.getEmail().equals(emailCriteria);
// Return the list of Contacts that match the given criteria. To do this we // just AND all the predicates together in a filter operation.
